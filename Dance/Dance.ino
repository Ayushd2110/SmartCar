/*Robo Car Multiple Function(Manual + Dance Mode)*/
...
char auth[] = "_7cl8wfR_0-5isxYJRXUTKq1BEBDdyoy"; //Enter your Blynk auth token
char ssid[] = "Redmi Note 11"; //Enter your WIFI name
char pass[] = "gadtya@09"; //Enter your WIFI passowrd
